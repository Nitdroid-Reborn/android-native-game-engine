...
public:
	...
	void CalculateDistance(const Vector3 &pointOnPlane) { distance=-normal.DotProduct(pointOnPlane); }
	...
	int ClassifyPoint(const Vector3 &point) const;
     ...
     //   QVector<Vector3> GetIntersectionsWithBoundingBox(const BoundingBox& bbox) const;
