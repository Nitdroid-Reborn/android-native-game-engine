...
void JNICommunication::Vibrate(unsigned int miliseconds) {
    JavaVM* lJavaVM = app->activity->vm;
    JNIEnv* lJNIEnv = app->activity->env;
    ...
    jmethodID method = lJNIEnv->GetMethodID(ClassNativeActivity, "Vibrate", "(I)V");
    lJNIEnv->CallVoidMethod(lNativeActivity, method, miliseconds);
